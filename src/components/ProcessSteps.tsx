      ...
      {steps.map((step, index) => {
        ...
        return (
          ...
          >
            ...
            {step.checkpoint && (
              <p className="mt-2 text-xs text-indigo-600 dark:text-indigo-300/80 italic">
            ...
            {isActive && (
              <div className="mt-4 pt-3 border-t border-slate-300 dark:border-slate-600/70 flex items-center justify-center gap-3">
                <button
