    ...
    return (
        <div className="p-4 md:p-6 h-full flex flex-col animate-fade-in-up">
            <div className="bg-slate-100 dark:bg-slate-900/50 border border-indigo-200 dark:border-indigo-500/50 rounded-xl p-6 md:p-8 text-center flex-grow flex flex-col justify-center">
                ...
                <div className="mt-6 bg-slate-200 dark:bg-slate-800/60 p-4 rounded-lg text-left">
                    <div className="flex items-start gap-3">
                        <LightbulbIcon className="h-6 w-6 text-yellow-500 dark:text-yellow-400 flex-shrink-0 mt-1" />
                        <div>
                ...
                {(report.unclearSteps.length > 0 || report.userQuestions.length > 0) && (
                    <div className="mt-4 bg-slate-200 dark:bg-slate-800/60 p-4 rounded-lg text-left">
                        <div className="flex items-start gap-3">
                            <HelpCircleIcon className="h-6 w-6 text-indigo-500 dark:text-indigo-400 flex-shrink-0 mt-1" />
                            <div>
            ...
            <div className="mt-6 flex flex-col sm:flex-row items-center justify-center gap-4 flex-shrink-0">
                <button
                    onClick={onRestart}
                    className="w-full sm:w-auto bg-slate-500 dark:bg-slate-600 hover:bg-slate-600 dark:hover:bg-slate-700 text-white text-sm font-semibold py-2 px-4 rounded-full transition-colors"
                >
                    Restart Training
                </button>
                <button
