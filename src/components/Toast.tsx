...
const icons = {
  ...
  error: <AlertTriangleIcon className="h-6 w-6 text-red-400" />,
  info: <InfoIcon className="h-6 w-6 text-blue-400" />,
};

const colors = {
    success: 'bg-green-900/80 border-green-700/80',
    error: 'bg-red-900/80 border-red-700/80',
    info: 'bg-blue-900/80 border-blue-700/80',
};
      ...
      <div className="p-4">
        <div className="flex items-start">
          ...
          <div className="ml-4 flex-shrink-0 flex">
            <button
              onClick={onDismiss}
              className="inline-flex rounded-md text-slate-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-slate-800 focus:ring-indigo-500"
            >
